        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (Yii::$app->user->isGuest): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= Url::toRoute(['/auth/signup']) ?>">Signup</a>
                    </li>

                <?php elseif (Yii::$app->user->identity->admin): ?>

                    <li class="nav-item">
                        <a class="nav-link" href="<?= Url::toRoute(['/admin/comment']) ?>"><b>Admin Panel</b></a>
                    </li>
                    <li class="nav-item">
